...
var Svg = /** @class */ (function (_super) {
    ...
    Svg.prototype.render = function () {
        ...
        var strokeSize = 2;
        return (React__default.createElement("svg", { version: "1.1", xmlns: "http://www.w3.org/2000/svg", style: styles, viewBox: "0 0 " + ((bounds && bounds.width) || 0) + " " + ((bounds && bounds.height) || 0), preserveAspectRatio: "none" },
            React__default.createElement("defs", null, React__default.createElement("pattern", { id: "panel-background", patternUnits: "userSpaceOnUse", width: "100%", height: "100%" },
                React__default.createElement("image", { xlinkHref: "https://i.imgur.com/mGKHSlA.png", preserveAspectRatio: "xMinYMin slice", x: "0", y: "0", 
                    // opacity=".4"
                    width: "100%", height: "100%" }))),
            React__default.createElement("g", { id: "Page-1", stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd" },
                React__default.createElement("g", { id: "100-by-exact", stroke: "url(#linearGradient-1)", strokeWidth: strokeSize },
                    React__default.createElement("path", { vectorEffect: "non-scaling-stroke", fill: "url(#panel-background)", d: this.props.path, id: "Pane_External_Box" }))),
...
var Sidebar = function (_a) {
    ...
    return (React__default.createElement("div", { style: {
        ...
        React__default.createElement("div", { style: { position: 'relative' } },
            React__default.createElement(MeasureAndRender, { stretch: true, debounce: 1 }, function (bounds) {
